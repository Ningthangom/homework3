...
function writePassword() {
    ...
    var passwordText = document.querySelector("#password");
      ...
      /*window.*/alert("The password must contain special charactor, upper case letter, lower case letter, and at least 8");
    var passowrdLength1 = prompt(" Choose a number greater than or equal to 8?");
